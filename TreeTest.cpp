...
int main()
{
    ...
    tc
        ...
        .CHECK_THROWS(emptytree.remove(3))
        .CHECK_EQUAL(emptytree.size(), 0)
        ...
        // .CHECK_EQUAL(tree2.size(), 7)
        // .CHECK_EQUAL(tree2.right(66), 33)
        // .CHECK_EQUAL(tree2.left(33), NULL)
        // .CHECK_EQUAL(tree2.parent(33), 66)
        // .CHECK_OK(tree2.remove(33))
        // .CHECK_EQUAL(tree2.contains(33), false)
        // .CHECK_EQUAL(tree2.right(66), NULL)
